...
get_data = (date_range, models) ->
  ...
  _.map ww, (hours, key) ->
    _.reduce hours, (m, o) ->
      ...
      m.proposed.actual += (parseInt(o.get('actual_hours'),    10) or 0) if _User.projects.get(o.get("project_id"))?.get("proposed") || false
      m.proposed.estimated += (parseInt(o.get('estimated_hours'), 10) or 0) if _User.projects.get(o.get("project_id"))?.get("proposed") || false
      m
