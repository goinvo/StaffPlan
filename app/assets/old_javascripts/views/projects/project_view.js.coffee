class views.projects.ProjectView extends window.StaffPlan.Views.Shared.DateDrivenView
  ...
  renderWeekHourCounter: ->
    @weekHourCounter = new window.StaffPlan.Views.Shared.ChartTotalsView @model.dateRangeMeta().dates, @model.users.models, ".project-header", @$ ".week-hour-counter"
