class ProjectsController < ApplicationController
  ...
  def index
    ...
    @totals_per_week = current_user.current_company.total_recap_for_date_range(Date.today.at_beginning_of_week, 3.month.from_now(Date.today.at_beginning_of_week))
